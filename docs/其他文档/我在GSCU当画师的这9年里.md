...
我打算给自己买台平板电脑画插图，正好，一位来自深圳的 GT 研究员来广州摆地摊，他蹲在路边，面前摆着一堆裸露着电路板的电子垃圾。我找到那位研究员，拿出我的 IC 卡，花了 29 GSD 买了一台平板电脑，虽然 RAM 只有 4GB，存储空间也只有 128GB，外壳甚至是 3D 打印的粗糙塑料，上面还残留着打磨的痕迹。但它运行的操作系统不是臃肿的 Android，而是 Lubuntu（注意，不是 Ubuntu。准确来说是在 Ubuntu Server ARM64 上安装了 `lubuntu-desktop`），一款轻量级的 Linux 发行版。
...
紧接着，2060 年 2 月，"仓鼠事变"爆发。仓鼠派蒙，也就是 LFN2312 的队长，要把整个 LFN2312 队伍卖给资本。
